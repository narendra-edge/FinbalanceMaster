...
{
    public class SchemeMappingConfiguration : IEntityTypeConfiguration<SchemeMapping>
    {
        public void Configure(EntityTypeBuilder<SchemeMapping> builder)
        {
            builder.ToTable("scheme_mapping");
            ...
            builder.Property(s => s.Switch_In_Allowed).HasColumnName("switch_in_allowed");
            builder.Property(s => s.Switch_Out_Allowed).HasColumnName("switch_out_allowed");
