...
namespace MutualFund.Core.Entities
{
    public class SchemeMapping
    {
        ...
        public string? RtaSource { get; set; }     // 'CAMS' or 'KFIN'
        ...
        public string? Switch_In_Allowed { get; set; }
        public string? Switch_Out_Allowed { get; set; }
        ...
        public string? MappingSource { get; set; }  // ISIN / EXACT / FUZZY / MANUAL
