...
namespace FnbIdentity.UI.Helpers.DependencyInjection
{
	...
	{
		/// <summary>
		/// Adds the FnbIdentity IdentityServer Admin UI with the default entity model.
		/// </summary>
		/// <param name="services"></param>
		/// <param name="optionsAction"></param>
		/// <returns></returns>

		public static IServiceCollection AddIdentityServerAdminUI<TIdentityServerDbContext, TPersistedGrantDbContext, TLogDbContext, TIdentityDbContext, TDataProtectionDbContext>(this IServiceCollection services, Action<IdentityServerAdminUIOptions> optionsAction)
			...
			=> AddIdentityServerAdminUI<TIdentityServerDbContext, TPersistedGrantDbContext, TLogDbContext, 
				           TIdentityDbContext,TDataProtectionDbContext, IdentityUser<string>, IdentityRole, 
        ...
        /// <summary>
        /// Adds the FnbIdentity Duende IdentityServer Admin UI with a custom user model and database context.
        /// </summary>
        ...
        /// <param name="optionsAction"></param>
        /// <returns></returns>
        public static IServiceCollection AddIdentityServerAdminUI<TIdentityServerDbContext, TPersistedGrantDbContext, TLogDbContext, TIdentityDbContext, TDataProtectionDbContext, TUser>(this IServiceCollection services, Action<IdentityServerAdminUIOptions> optionsAction)
			...
			=> AddIdentityServerAdminUI<TIdentityServerDbContext, TPersistedGrantDbContext, TLogDbContext, TIdentityDbContext, TDataProtectionDbContext, TUser, IdentityRole, IdentityUserClaim<string>,
				IdentityUserRole<string>, IdentityUserLogin<string>, IdentityRoleClaim<string>,
		...
		/// <summary>
		/// Adds the FnbIdentity Duende IdentityServer Admin UI with a fully custom entity model and database contexts.
		/// </summary>
		/// <param name="services"></param>
		/// <param name="optionsAction"></param>
		/// <returns></returns>
		public static IServiceCollection AddIdentityServerAdminUI<TIdentityServerDbContext, TPersistedGrantDbContext, TLogDbContext, TIdentityDbContext, TDataProtectionDbContext, TUser, TRole, TUserClaim,
			...
			
		{
			...
			if (!options.Testing.IsStaging)
			{
				services.RegisterDbContexts<TIdentityServerDbContext,
					...
					TDataProtectionDbContext>(options.ConnectionStrings, options.DatabaseProvider, options.DatabaseMigrations);
			}
			else
			{
			...
			services.AddDataProtection<TDataProtectionDbContext>(options.DataProtection);
			...
			healthChecksBuilder.AddIdSHealthChecks<TIdentityServerDbContext, TPersistedGrantDbContext,
				 TLogDbContext, TIdentityDbContext,
				TDataProtectionDbContext>(options.Admin, options.ConnectionStrings, options.DatabaseProvider);
