...
using FnbIdentity.STS.Identity.Configuration.ApplicationParts;
using FnbIdentity.STS.Identity.Configuration.Constants;
using FnbIdentity.STS.Identity.Configuration.Interfaces;
using FnbIdentity.STS.Identity.Helpers.Localization;
using FnbIdentity.STS.Identity.Services;
...
#pragma warning restore CS8634 // The type cannot be used as type parameter in the generic type or method. Nullability of type argument doesn't match 'class' constraint.
        ...
        public static IIdentityServerBuilder AddIdentityServer<TConfigurationDbContext, TPersistedGrantDbContext, 
            TUserIdentity>(this IServiceCollection services,IConfiguration configuration)
            where TPersistedGrantDbContext : DbContext, IAdminPersistedGrantDbContext
            where TConfigurationDbContext : DbContext, IAdminConfigurationDbContext
            where TUserIdentity : class
        {
