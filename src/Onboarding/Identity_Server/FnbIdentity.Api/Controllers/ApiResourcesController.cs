...
using FnbIdentity.Api.Dtos.ApiResources;
...
namespace FnbIdentity.Api.Controllers
{
    ...
    public class ApiResourcesController : ControllerBase
    {
        ...
        public ApiResourcesController(IApiResourceService apiResourceService,IApiErrorResources apiErrorResources)
        {
            _apiResourceService = apiResourceService;
            _errorResources = apiErrorResources;
        }
